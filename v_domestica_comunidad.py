...
ax.bar(autonomias, vic_pro_ext_may['Indice'],bottom=vic_pro_esp_may['Indice']+vic_pro_esp_men['Indice'], label='Extranjera Mayor Edad')
ax.bar(autonomias, vic_pro_ext_men['Indice'],bottom=vic_pro_esp_may['Indice']+vic_pro_esp_men['Indice']+vic_pro_ext_may['Indice'], label='Extranjera Menor Edad')
